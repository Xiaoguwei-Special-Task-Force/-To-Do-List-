...
// 带颜色的分类显示
func colorCategory(c common.TaskCategory) string {
    colors := map[common.TaskCategory]string{
        common.Work:     "\033[34m工作\033[0m",  // 蓝色
        common.Personal: "\033[32m个人\033[0m",  // 绿色
        common.System:   "\033[31m系统\033[0m",  // 红色
        common.Other:    "\033[33m其他\033[0m",  // 黄色
    }
    return colors[c]
}